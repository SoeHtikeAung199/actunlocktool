...
}); /*!* Bootstrap v3.3.7 (http://getbootstrap.com) * Copyright Twitter, Inc. * Licensed under MIT*/
...
}(window.Zepto || window.jQuery, window, document); /*!jQuery Form Plugin | Version: 3.51.0-2014.06.20 | Requires jQuery v1.5 or later | Copyright (c) 2014 M. Alsup | Dual licensed under the MIT and GPL licenses.*/
! function(e) {
    "use strict";
...
}); /*!jQuery Validation Plugin - v1.16.0 | Copyright (c) 2016 Jörn Zaefferer; Licensed MIT*/
! function(a) {
...
}); /*!Magnific Popup - v0.9.9 | Copyright (c) 2013 Dmitry Semenov*/
(function(e) {
...
})(window.jQuery || window.Zepto); /*!WOW - v1.1.3 | Copyright (c) 2016 Matthieu Aussaguel*/
(function() {
...
}).call(this); /*!particles.js | Author : Vincent Garreau | MIT license*/
function hexToRgb(e) {
...
$.cookie = function(e, t, r) {
    ...
    if (r.expires && ("number" == typeof r.expires || r.expires.toUTCString)) {
        var u;
        "number" == typeof r.expires ? (u = new Date, u.setTime(u.getTime() + 24 * r.expires * 60 * 60 * 1e3)) : u = r.expires, a = "; expires=" + u.toUTCString()
    }
    var p = r.path ? "; path=" + r.path : "",
        c = r.domain ? "; domain=" + r.domain : "",
        h = r.secure ? "; secure" : "";
    document.cookie = [e, "=", encodeURIComponent(t), a, p, c, h].join("")
}, jQuery(function() {
    themes_panel_width = jQuery("#themes_menu").outerWidth(), jQuery("#themes_panel").css("right", 0), jQuery("#themes_panel").animate({
        right: -themes_panel_width
    }, 400), jQuery("#toggle_button a.toggle-theme-panel").click(function() {
        var e = jQuery(this).parent().parent();
        return e.animate({
            right: 0 == parseInt(e.css("right"), 10) ? -themes_panel_width : 0
        }, 400), !1
    }), jQuery("#themes_panel ul.theme.cookie_layout_style li a").click(function() {
        var e = jQuery(this).attr("title");
        return $.cookie("cookie_style", e, {
            expires: 0,
            path: "/"
        }), jQuery("#layoutstyle").attr("href", "assets/css/" + e + ".css"), !1
    })
});